...
import { Phone, Mail, MapPin, Send, CheckCircle, AlertCircle, Clock, ArrowRight } from 'lucide-react';
...
export default function ContactUs({ darkMode }: Props) {
  ...
  const inputCls = `w-full px-4 py-3 rounded-xl border text-sm font-medium transition-colors outline-none focus:ring-2 focus:ring-blue-500/25 ${
    darkMode
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-5 gap-10 lg:gap-14">
              ...
              <RevealSection>
                ...
                <RevealSection>
                  <div className="reveal opacity-0 mt-2 p-5 rounded-2xl bg-blue-600 text-white">
                    ...
                    <p className="text-blue-100 text-sm mb-3">Available around the clock for urgent plumbing, electrical, and engineering emergencies.</p>
                    <a
                      href="tel:+447393264576"
                    ...
                    >
                      <Phone size={14} /> Call Now: +44 7393 264576
                    </a>
                  </div>
                </RevealSection>
              </RevealSection>
            ...
            <RevealSection className="lg:col-span-3">
              <div className={`reveal opacity-0 rounded-2xl border p-6 sm:p-8 ${
                ...
                {status === 'success' ? (
                  <div className="flex flex-col items-center justify-center py-16 text-center">
                    ...
                    <p className={`text-sm leading-relaxed max-w-sm mb-8 ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                      Our team will review your request and respond to you via email or phone 
                      as soon as possible. For urgent matters, please call us directly on{' '}
                      <a href="tel:+447393264576" className="text-blue-500 font-semibold">+44 7393 264576</a> — we're available 24/7.
                    </p>
                    <button
                    ...
                    <form onSubmit={handleSubmit} noValidate className="space-y-5">
                      ...
                      <div className="grid sm:grid-cols-2 gap-5">
                        ...
                        <div>
                          ...
                          <select
                            ...
                            className={`${inputCls} ${errors.service ? 'border-red-400' : ''}`}
                          >
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          rows={5} placeholder="Please describe your project or enquiry in as much detail as possible..."
                      ...
                      {status === 'error' && (
                        <div className="bg-red-50 border border-red-200 rounded-xl p-4 flex items-center gap-2 text-red-700 text-sm">
                          ...
                          <a href="tel:+447393264576" className="font-bold underline">+44 7393 264576</a>.
                        </div>
                      )}
