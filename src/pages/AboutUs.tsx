...
import { Award, Users, ShieldCheck, TrendingUp, CheckCircle, ArrowRight } from 'lucide-react';
...
const values = [
  { icon: Award,      title: 'Quality Assured',   desc: 'Every project meets the highest industry standards with rigorous quality control at every stage.' },
  { icon: ShieldCheck, title: 'Safety First',     desc: 'Full compliance with health & safety regulations. We never compromise on worker or site safety.' },
  { icon: Users,       title: 'Customer Focus',   desc: 'We listen, plan, and deliver tailored solutions built entirely around your specific requirements.' },
  { icon: TrendingUp,  title: 'Reliable Results', desc: 'On-time delivery, transparent pricing, and open communication from start to finish.' },
];
...
export default function AboutUs({ darkMode }: Props) {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <RevealSection>
              ...
              <div className={`reveal opacity-0 absolute -bottom-5 -right-5 hidden lg:flex items-center gap-4 ${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-2xl shadow-xl p-5`}>
            ...
            <RevealSection>
              ...
              <p className={`reveal opacity-0 text-base leading-relaxed mb-4 ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                Founded in Dudley, SR Engineering Dudley LTD has been delivering high-quality 
                engineering solutions to residential, commercial, and industrial clients for over 
                15 years. We combine deep technical expertise with an unwavering commitment to 
                customer satisfaction.
              </p>
              <p className={`reveal opacity-0 text-base leading-relaxed mb-8 ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                From complex industrial welding and fabrication to critical electrical installations 
                and PAT compliance testing, our skilled team brings precision and professionalism 
                to every project — no matter the scale. Our base at Unit 6, Castlegate Way, Dudley 
                serves as a hub for engineering excellence across the West Midlands.
              </p>
      ...
      <section className={`py-24 ${darkMode ? 'bg-gray-950' : 'bg-gray-50'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <RevealSection className="text-center max-w-xl mx-auto mb-14">
            <div className="reveal opacity-0 inline-flex items-center gap-2 bg-blue-100 text-blue-700 text-sm font-semibold px-4 py-1.5 rounded-full mb-4">Our Values</div>
