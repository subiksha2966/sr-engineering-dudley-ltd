      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-6">
              Professional engineering services across Dudley and the West Midlands. Available 24 hours a day, 7 days a week.
            </p>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col items-center gap-4">
          ...
          <p className="text-gray-500 text-xs sm:text-sm text-center">
            ...
            <span className="text-blue-400 font-semibold hover:text-blue-300 hover:underline underline-offset-2 decoration-blue-400/50 transition-colors cursor-default">Subiksha Ramesh & Swathi Barani</span>
          </p>
